...
<div class="container invoice-container bg-light">
    <div class="row align-items-center">
        ...
        <div class="col-sm-5 text-center text-sm-center">
            <h1 class="mb-0">ENA COACH</h1>
            
        </div>
        <div class="col-sm-5 text-center text-sm-right">
<//h4 class="mb-0"></h4>
<//p class="mb-0">  <//?php echo $invoice_id;?></p>
        </div>
    </div>
    <hr class="my-4">
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 mb-3 mb-sm-0"> <span class="text-black-50 text-uppercase">Bus</span><br>
            <span class="font-weight-500 text-3"><?php echo $invoice_row['name'].' ';?></span> </div>
        ...
        <div class="col-sm-4 mb-3 mb-sm-0"> <span class="text-black-50 text-uppercase">Total Fare:</span><br>
            <span class="font-weight-500 text-3"><?php echo $invoice_row['price']*$_count_ticket.'Ksh'?></span> </div>
    </div>
    <br>
