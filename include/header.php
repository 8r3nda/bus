...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light bd-navbar shadow p-3 mb-5 bg-primary rounded">
    <div class="container">
        <div class="logo">
            <a href="index.php" title="EBus"><img src="" alt="" width="85" ></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <h6><a class="nav-link " href="buslist.php">Bus Route</a></h6>
                </li>
                <?php
                if (!isset($_SESSION['name'])) {
                    ?>
                    <li class="nav-item">
                        <h6><a class="nav-link " href="login.php">Log in</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <h6><a name="logout" class="nav-link " href="index.php?logout='1'">Log out</a></h6>
                    </li>
                    <?php
