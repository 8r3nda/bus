    ...
    <table class="table text-xl-center">
        ...
        while($row = mysqli_fetch_assoc($a_data)) {
            ...
            <tr>
                ...
                <td>
                    <span class="d-inline-block d-sm-block text-dark mb-sm-1"><?php echo $row['price']; ?>Ksh</span>
...
include 'include/footer.php';
    ...
    <div class="container bg-light shadow-md rounded py-4">
        <div class="mx-3 mb-3 text-center">
            <h4 class="">Available Buses on <?php echo $date ?></h4>
    ...
    <div class="container bg-light shadow-md rounded py-4">
        <div class="mx-3 mb-3 text-center">
            <h4 class="">ENA COACH</h4>
            <h5>Please Select Date Of Travel</h5>
            ...
            while ($row = mysqli_fetch_assoc($a_data)) {
                ...
                <tr>
                    ...
                    <td><span class="text-dark"><?php echo $row['a_time']; ?></span> <small
                                class="text-muted d-block"><?php echo $row['a_place']; ?></small></td>
                    <td>
                        <span class="d-inline-block d-sm-block text-dark mb-sm-1"><?php echo $row['price']; ?></span>
