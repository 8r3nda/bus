...
<div class="container bg-light shadow-md rounded px-4 py-4">
    <div class="row align-items-center border-bottom-4">
        <!-- Bus Search Start -->
        <div class="col-sm-4">
        <h3 class="text-4 mb-3">Need a ride? </h3>
            <h2 class="text-4 mb-3">Book Tickets!!</h2>
...
<div class="container">
    <section class="section pb-4">
        <h2 class="font-weight-600 text-center">Why Book with Ena Coach?</h2>
        <p class="lead mb-5 text-center"> We provide exemplary service!</p>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="featured-box style-1 mb-4">
                    ...
                    <h3>Nyanza Routes</h3>
                    <p>Make your road journeys easier across Nyanza with our operators.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="featured-box style-1 mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="featured-box text-center">
                            ...
                            <h4>Refer &amp; Earn</h4>
                            <p>Invite a friend to sign up and earn up to 100ksh.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="featured-box text-center">
